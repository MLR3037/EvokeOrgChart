...
var OrgChartWebPart = /** @class */ (function (_super) {
    __extends(OrgChartWebPart, _super);
    function OrgChartWebPart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    OrgChartWebPart.prototype.render = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        client = _a.sent();
                        element = React.createElement(OrgChart, {
                            graphClient: client,
    ...
    OrgChartWebPart.prototype.onDispose = function () {
        ReactDom.unmountComponentAtNode(this.domElement);
    };
    Object.defineProperty(OrgChartWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    OrgChartWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    ...
                    groups: [
                        {
                            ...
                            groupFields: [
                                PropertyPaneTextField('rootUserEmail', {
                                    ...
                                    description: 'Pin the chart to a specific person (e.g. ceo@yourcompany.com). ' +
...
export default OrgChartWebPart;
//# sourceMappingURL=OrgChartWebPart.js.map